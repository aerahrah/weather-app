...
const CurrentTime = ({ currentTimeData }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md lg:row-start-1 lg:col-start-2 ">
      <div className="p-4 md:p-6 lg:p-8 xl:p-10 flex flex-wrap justify-between items-between gap-2 md:gap-4 lg:gap-6 text-gray-500 text-md lg:text-lg">
        ...
        <div className="flex xl:flex-col justify-between w-full text-sm sm:text-md sm:w-auto  gap-2 lg:gap-4">
